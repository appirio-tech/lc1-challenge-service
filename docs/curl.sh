...
if [ $ADD_PARTICPANTS = "true" ]; then
  ...
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "OWNER", "userId": 1 , "userHandle": "test_user"}' $URL$RESOURCE
  ...
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "OWNER", "userId": 1 , "userHandle": "test_user" }' $URL$RESOURCE
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "REVIEWER", "userId": 20 , "userHandle": "test_user"}' $URL$RESOURCE
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "SUBMITTER", "userId": 30 , "userHandle": "test_user" }' $URL$RESOURCE
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "WATCHER", "userId": 40 , "userHandle": "test_user" }' $URL$RESOURCE
  ...
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "SUBMITTER", "userId": 30  , "userHandle": "test_user"}' $URL$RESOURCE
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "WATCHER", "userId": 40 , "userHandle": "test_user" }' $URL$RESOURCE
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "SUBMITTER", "userId": 50 , "userHandle": "test_user"  }' $URL$RESOURCE
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "WATCHER", "userId": 60 , "userHandle": "test_user" }' $URL$RESOURCE
...
if [ $ADD_SUBMISSION = "true" ]; then
  ...
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "submitterId": 30, "status": "VALID", "submitterHandle" : "_indy" }' $URL$RESOURCE

  RESOURCE="/4/submissions"
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "submitterId": 30, "status": "VALID", "submitterHandle" : "_indy" }' $URL$RESOURCE
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "submitterId": 50, "status": "INVALID", "submitterHandle" : "_indy" }' $URL$RESOURCE
