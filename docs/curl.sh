...
if [ $ADD_PARTICPANTS = "true" ]; then
  ...
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "OWNER", "userId": 1 , "user_handle": "test_user"}' $URL$RESOURCE
  ...
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "OWNER", "userId": 1 , "user_handle": "test_user" }' $URL$RESOURCE
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "REVIEWER", "userId": 20 , "user_handle": "test_user"}' $URL$RESOURCE
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "SUBMITTER", "userId": 30 , "user_handle": "test_user" }' $URL$RESOURCE
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "WATCHER", "userId": 40 , "user_handle": "test_user" }' $URL$RESOURCE
  ...
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "SUBMITTER", "userId": 30  , "user_handle": "test_user"}' $URL$RESOURCE
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "WATCHER", "userId": 40 , "user_handle": "test_user" }' $URL$RESOURCE
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "SUBMITTER", "userId": 50 , "user_handle": "test_user"  }' $URL$RESOURCE
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "WATCHER", "userId": 60 , "user_handle": "test_user" }' $URL$RESOURCE
...
if [ $ADD_SUBMISSION = "true" ]; then
  ...
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "submitterId": 30, "status": "VALID", "submitter_handle" : "_indy" }' $URL$RESOURCE

  RESOURCE="/4/submissions"
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "submitterId": 30, "status": "VALID", "submitter_handle" : "_indy" }' $URL$RESOURCE
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "submitterId": 50, "status": "INVALID", "submitter_handle" : "_indy" }' $URL$RESOURCE
