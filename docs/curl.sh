...
if [ $ADD_PARTICPANTS = "true" ]; then
  ...
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "OWNER", "userId": 1, "user_handle": "user_one" }' $URL$RESOURCE
  ...
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "OWNER", "userId": 1, "user_handle":"user_one" }' $URL$RESOURCE
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "REVIEWER", "userId": 20, "user_handle":"user_twenty" }' $URL$RESOURCE
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "SUBMITTER", "userId": 30, "user_handle":"user_thirty" }' $URL$RESOURCE
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "WATCHER", "userId": 40, "user_handle":"user_forty" }' $URL$RESOURCE
  ...
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "SUBMITTER", "userId": 30, "user_handle":"user_thirty" }' $URL$RESOURCE
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "WATCHER", "userId": 40, "user_handle":"user_forty" }' $URL$RESOURCE
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "SUBMITTER", "userId": 50, "user_handle":"user_fifty" }' $URL$RESOURCE
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "role": "WATCHER", "userId": 60, "user_handle":"user_sixty" }' $URL$RESOURCE
...
if [ $ADD_SUBMISSION = "true" ]; then
  ...
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "submitterId": 30, "submitter_handle":"user_thirty", "status": "VALID" }' $URL$RESOURCE

  RESOURCE="/4/submissions"
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "submitterId": 30, "submitter_handle":"user_thirty", "status": "VALID" }' $URL$RESOURCE
  curl -X POST -H "Content-Type: application/json" -H "Cache-Control: no-cache"  -d '{ "submitterId": 50, "submitter_handle":"user_fifty", "status": "INVALID" }' $URL$RESOURCE
